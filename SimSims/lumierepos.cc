...
LumierePos::LumierePos(bool t, std::__cxx11::string n, int posXInit, int posYInit, int posZInit) : _typeButton(t), _nom(n), _positionX(posXInit), _positionY(posYInit), _positionZ(posZInit), _couleurR(0), _couleurG(0), _couleurB(0)
{}
