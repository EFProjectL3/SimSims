    ...
    QMainWindow(parent),TOUS_LES_OBJETS(),TOUTES_LES_ADRESSE_TEXTURES(), NOM_DES_FORMES(), ENSEMBLE_LUM_POS()
{
    ...
    _posX_min_lp = new QLabel("-30", this);
    _s_posX_lp = new QSlider(Qt::Horizontal, this);
    _s_posX_lp->setMinimum(-30);
    _s_posX_lp->setMaximum(30);
    _posX_max_lp = new QLabel("30", this);
    ...
    _posY_min_lp = new QLabel("-30", this);
    _s_posY_lp = new QSlider(Qt::Horizontal, this);
    _s_posY_lp->setMinimum(-30);
    _s_posY_lp->setMaximum(30);
    _posY_max_lp = new QLabel("30", this);
    ...
    _posZ_min_lp = new QLabel("-30", this);
    _s_posZ_lp = new QSlider(Qt::Horizontal, this);
    _s_posZ_lp->setMinimum(-30);
    _s_posZ_lp->setMaximum(30);
    _posZ_max_lp = new QLabel("30", this);
    ...
    _posX_min_obj = new QLabel("-30", this);
    _s_posX_obj = new QSlider(Qt::Horizontal, this);
    _s_posX_obj->setMinimum(-30);
    _s_posX_obj->setMaximum(30);
    _posX_max_obj = new QLabel("30", this);
    ...
    _posY_min_obj = new QLabel("-30", this);
    _s_posY_obj = new QSlider(Qt::Horizontal, this);
    _s_posY_obj->setMinimum(-30);
    _s_posY_obj->setMaximum(30);
    _posY_max_obj = new QLabel("30", this);
    ...
    _posZ_min_obj = new QLabel("-30", this);
    _s_posZ_obj = new QSlider(Qt::Horizontal, this);
    _s_posZ_obj->setMinimum(-30);
    _s_posZ_obj->setMaximum(30);
    _posZ_max_obj = new QLabel("30", this);
    ...
    _angX_min_obj = new QLabel("-180", this);
    _s_angX_obj = new QSlider(Qt::Horizontal, this);
    _s_angX_obj->setMinimum(-180);
    _s_angX_obj->setMaximum(180);
    _angX_max_obj = new QLabel("180", this);
    ...
    _angY_min_obj = new QLabel("-180", this);
    _s_angY_obj = new QSlider(Qt::Horizontal, this);
    _s_angY_obj->setMinimum(-180);
    _s_angY_obj->setMaximum(180);
    _angY_max_obj = new QLabel("180", this);
    ...
    _angZ_min_obj = new QLabel("-180", this);
    _s_angZ_obj = new QSlider(Qt::Horizontal, this);
    _s_angZ_obj->setMinimum(-180);
    _s_angZ_obj->setMaximum(180);
    _angZ_max_obj = new QLabel("180", this);
...
;
    ...
    {
        QLabel * lImText = new QLabel(this);
        ...
        _layoutTextures->addWidget(lImText, i, 0, 1, 1);
    }

        _layoutTextures->addWidget(_loadText, TOUTES_LES_ADRESSE_TEXTURES.size()+1, 0, 1, 1);
